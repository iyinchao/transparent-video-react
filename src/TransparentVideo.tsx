...
import {
  ...
  type TransparentVideoSourceProps,
} from './TransparentVideo.types';
 ...
 *
 * This component renders transparent video using WebGL compositing
...
export const TransparentVideo = forwardRef<TransparentVideoRef, TransparentVideoProps>(
  ...
  TransparentVideoProps & React.RefAttributes<TransparentVideoRef>
> & {
  Source: typeof TransparentVideoSource;
};
TransparentVideo.displayName = 'TransparentVideo';

TransparentVideo.Source = TransparentVideoSource;
